...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    let lifetime = array[i].years.split(' - ');
...
function addArtist(array) {
  array.push(
    { 
      ...
      bio: "I spend a lot of time listening to music and doing some doodling! I prefer spaghetti over mac and cheese"
    } 
  );
...
function artistInfo(array, artistName){
  // tests are expecting a bio in an array, not just the bio string
  let artistBio = [];
